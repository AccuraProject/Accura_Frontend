...
const API_BASE_URL = ensureSecureProtocol('https://api-accura-dev.azurewebsites.net/');
const NOTIFICATIONS_WS_URL = ensureSecureProtocol('wss://api-accura-dev.azurewebsites.net/notifications/ws');
